  ...
  const saveGradeYear1 = () => {
    ...
    if (totalScore < 0 || totalScore > 100) {
      ...
      setGradesYear1((currentGrades) => {
        // Calculate total score for 1-credit courses for P/NP determination
        const totalScore = Number(newGradeYear1.출석점수) + Number(newGradeYear1.과제점수) +
                       Number(newGradeYear1.중간고사) + Number(newGradeYear1.기말고사);
  
        const gradeWithTotal = {
          ...newGradeYear1,
          총점: newGradeYear1.학점 === "1" ? 0 : totalScore, // Keep 총점 0 for GPA calculation
          성적: newGradeYear1.학점 === "1" ? (totalScore >= 60 ? 'P' : 'NP') : getGrade(totalScore, Number(newGradeYear1.학점))
        };
  ...
  const saveGradeYear2 = () => {
    ...
    if (totalScore < 0 || totalScore > 100) {
      ...
      setGradesYear2((currentGrades) => {
        ...
        const gradeWithTotal = {
          ...newGradeYear2,
          총점: newGradeYear2.학점 === "1" ? 0 : totalScore, // Keep 총점 0 for GPA calculation
          성적: newGradeYear2.학점 === "1" ? (totalScore >= 60 ? 'P' : 'NP') : getGrade(totalScore, Number(newGradeYear2.학점))
        };
  ...
  const saveGradeYear3 = () => {
    ...
    if (totalScore < 0 || totalScore > 100) {
      ...
      setGradesYear3((currentGrades) => {
        ...
        const gradeWithTotal = {
          ...newGradeYear3,
          총점: newGradeYear3.학점 === "1" ? 0 : totalScore, // Keep 총점 0 for GPA calculation
          성적: newGradeYear3.학점 === "1" ? (totalScore >= 60 ? 'P' : 'NP') : getGrade(totalScore, Number(newGradeYear3.학점))
        };
